...
|3|프레디 진짜 너무 좋네요! 그러니까 역시 돈이 최고라구요 ㅎ|1|
|..|...|...|...|
...
랜덤으로 추출한 학습 데이터의 결과는 optimizer를 여러번 수정하여 돌려보았지만 정확도가 **0.6 에서 0.75** 로 아주 낮은 수치를 나타냈다. 
학습 데이터의 정확도가 낮은 이유를 찾아본 결과, **리뷰 데이터 자체의 문제** 일 가능성이 높다고 판단하였다.  
...
|3|카오스 거지같다.무슨 밸런스가 이따윈지..카오스 굳이 안넣어도 될듯 한데..필드에만 강한 몹이 생성되는걸로 바꾸던지...|1|
|..|...|...|...|
